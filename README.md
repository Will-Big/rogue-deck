...
Unity **6000.5.2f1** 프로젝트입니다. 게임 규칙은 UnityEngine을 참조하지 않는 순수 C# 코어
(`Assets/Core`)에 있고, 표현과 저작은 Unity 레이어(`Assets/Unity`)에 있습니다. 그래서 규칙은
에디터 없이 검증됩니다.
...
| 경로 | 내용 |
|---|---|
| `Assets/Core` | 게임 규칙. UnityEngine 미참조, 결정론적, 출력은 이벤트 타임라인 |
| `Assets/Unity` | 씬·프리팹·표현. 규칙 판단을 하지 않습니다 |
| `Assets/StreamingAssets/Content` | 카드·상태·덱·풀·캐릭터의 저작 원본 JSON |
