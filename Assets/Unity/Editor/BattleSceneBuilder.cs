...
namespace FateWeaver.Unity.Editor
{
    ...
    public static class BattleSceneBuilder
    {
        ...
        public static void Build()
        {
            ...
            var drawPile = PileView.Create(pilesRoot, overlay, "뽑을 덱", cardPrefabs, buttonSize);
            Place((RectTransform)drawPile.transform, new Vector2(0f, 0f), new Vector2(90f, 70f), buttonSize);
            var discardPile = PileView.Create(pilesRoot, overlay, "버린 덱", cardPrefabs, buttonSize);
            Place((RectTransform)discardPile.transform, new Vector2(1f, 0f), new Vector2(-90f, 70f), buttonSize);
            var fullDeck = PileView.Create(pilesRoot, overlay, "전체 덱", cardPrefabs, buttonSize);
