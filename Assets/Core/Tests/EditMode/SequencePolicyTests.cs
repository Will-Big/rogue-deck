...
{
    public class SequencePolicyTests
    {
        [Test]
        public void For_turn_returns_that_turns_cards_and_clamps_past_the_end()
        {
            ...
            var intent = new SequencePolicy(new IReadOnlyList<CardDefinition>[] { t0, t1 });
        ...
        {
            var intent = new SequencePolicy(new List<IReadOnlyList<CardDefinition>>());
