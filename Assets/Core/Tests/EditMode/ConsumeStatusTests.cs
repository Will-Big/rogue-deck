    ...
    public class ConsumeStatusTests
    {
        ...
        public void Exact_consumes_nothing_when_short_and_skips_the_reward()
        {
            ...
            var events = Resolve(state,
                ...
                new EffectData(EffectKeys.Damage, 5) { Requirement = new EffectResultRequirement("pay", 1) });
        ...
        public void Exact_consumes_the_full_amount_when_available()
        {
            ...
            var events = Resolve(state,
                Consume("pay", 3, ConsumptionMode.Exact),
                new EffectData(EffectKeys.Damage, 5) { Requirement = new EffectResultRequirement("pay", 3) });
        ...
        public void Scaling_adds_the_consumed_amount_times_the_factor()
        {
            ...
            var events = Resolve(state,
                ...
                new EffectData(EffectKeys.Damage, 2) { Scaling = new EffectResultScaling("pay", 2) });
        ...
        public void A_reward_reads_only_the_effect_it_names()
        {
            ...
            var events = Resolve(state,
                ...
                new EffectData(EffectKeys.Damage, 5) { Requirement = new EffectResultRequirement("second", 1) });
        ...
        public void Requirement_skips_the_effect_when_nothing_was_consumed()
        {
            ...
            Resolve(withPoison,
                ...
                new EffectData(EffectKeys.Damage, 4) { Requirement = new EffectResultRequirement("pay", 1) });
        ...
        public void Start_condition_is_fixed_even_when_the_card_changes_what_it_checked()
        {
            ...
            {
                new EffectData(EffectKeys.Damage, 10) { TargetSelector = TargetSelector.All },
                new EffectData(EffectKeys.Damage, 1) { TargetSelector = TargetSelector.All, SuccessEffectValue = 9 }
            })
            {
