...
| [카드 아이디어 노트](specs/2026-07-27-card-idea-notebook-design.md) | `current` | 외부 카드 초안 즉시 보존, 아군·적군 진영, 개별·전체 저장, 카드 순서·파일명, Markdown 입출력 | 카드 아이디어 도구 구현·변경 |
...
| [카드 노트 진영과 명시적 저장](plans/2026-07-28-card-notebook-faction-save.md) | `active` | 아군·적군 분기, 스키마 5, 현재·전체 저장과 키보드 단축키 |
