...
| 문서 | 상태 | 범위 |
|---|---|---|
| [HandFan 시각 테스트 씬](plans/2026-09-22-handfan-sandbox.md) — [HTML 검토](plans/2026-09-22-handfan-sandbox.html) | `active` | 기존 HandFan의 카드 추가·선택 제거·전체 비우기·장수 표시. 계획 검토 대기, 전투 규칙·새 연출 제외 |
