...
| [카드 아이디어 노트](specs/2026-07-27-card-idea-notebook-design.md) | `current` | 외부 카드 초안 즉시 보존, 공용 선택·일괄 삭제, 카드 순서·파일명, Markdown 입출력 | 카드 아이디어 도구 구현·변경 |
...
| [카드 노트 자신 대상](plans/2026-07-28-card-notebook-self-target.md) | `active` | 아군·적군 자신 `◎`, 동시 자신 차단, Markdown 왕복과 내보내기 버튼 명칭 |
