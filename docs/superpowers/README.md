...
| 문서 | 상태 | 범위 |
|---|---|---|
| [B안 카드 프리팹 적용](plans/2026-09-20-card-b-prefab.md) — [HTML 검토](plans/2026-09-20-card-b-prefab.html) | `active` | 확정 목업의 표식·내부 이름/비용·아트·단일/복합 대상·고정 제목을 프리팹에 적용하는 검토안. 승인 후 기존 카드 프레임 계획의 해당 시각 단계를 대체. 코드 구현 전 |
