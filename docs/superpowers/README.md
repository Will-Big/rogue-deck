...
| 문서 | 상태 | 범위 |
|---|---|---|
| [HandFan 시각 테스트 씬](plans/2026-09-22-handfan-sandbox.md) — [HTML 검토](plans/2026-09-22-handfan-sandbox.html) | `active` | 최신 master의 HandFanView·HandFanLayoutView를 사용하는 카드 추가·선택 제거·전체 비우기·장수 표시. codex/handfan-sandbox에서 구현·자동 검증 완료, 사용자 Play 검수·머지 대기. 전투 규칙·새 연출 제외 |
