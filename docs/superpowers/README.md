...
| [프리미티브 카드 프레임과 구조화 설명](specs/2026-07-31-primitive-card-frame-design.md) | `current` | 실행·개입 프레임 분리, 심볼 대상 칸, 구조화 설명, 반응형 핸드 | 카드 프레임·설명 표시·핸드 레이아웃 구현 |
...
| 문서 | 상태 | 범위 |
|---|---|---|
| [프리미티브 카드 프레임과 구조화 설명 구현](plans/2026-07-31-primitive-card-frame.md) | `active` | 전역 대상 그룹화, 색상 전용 설명·대상 심볼, 실행·개입 폼팩터, 반응형 손패 회귀와 완료 검증 |
