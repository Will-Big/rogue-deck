...
- [ ] **Step 3: Move the 15 historical specs**
...
- [ ] **Step 4: Move the 42 pre-existing historical plans**
...
- [ ] **Step 5: Delete only the approved abandoned specs**
...
- [ ] **Step 1: Standardize current-document headers**
...
- [ ] **Step 2: Reconcile party card ownership**
...
- [ ] **Step 3: Update roadmap links and statuses**
...
- [ ] **Step 4: Repair moved-document links**
...
- [ ] **Step 1: Create the central current-document index**
...
- [ ] **Step 3: Add the repository instruction**
...
- [ ] **Step 4: Archive this completed implementation plan**
...
- [ ] **Step 1: Verify final counts and approved deletions**
...
- [ ] **Step 4: Run formatting and full tests**
...
- [ ] **Step 5: Commit the implemented reorganization**
