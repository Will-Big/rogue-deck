...
- [ ] **Step 2: 배율을 `StatusContentDefaults`로 인라인한다**
...
- [ ] **Step 4: 설명 카탈로그가 콘텐츠에서 이름을 읽게 한다**
